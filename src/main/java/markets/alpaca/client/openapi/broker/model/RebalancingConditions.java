...
public class RebalancingConditions implements Serializable {
  ...
  public RebalancingConditions day(@javax.annotation.Nullable String day) {
    this.day = day;
    return this;
  }
  ...
  public RebalancingConditions percent(@javax.annotation.Nullable String percent) {
  ...
  public RebalancingConditions subType(@javax.annotation.Nullable String subType) {
  ...
  public RebalancingConditions type(@javax.annotation.Nullable String type) {
    this.type = type;
    return this;
  }
   ...
   * @return the RebalancingConditions instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.day, rebalancingConditions.day) &&
        Objects.equals(this.percent, rebalancingConditions.percent) &&
        Objects.equals(this.subType, rebalancingConditions.subType) &&
        Objects.equals(this.type, rebalancingConditions.type)&&
        Objects.equals(this.additionalProperties, rebalancingConditions.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(day, percent, subType, type, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("day", "percent", "sub_type", "type"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to RebalancingConditions
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RebalancingConditions.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RebalancingConditions is not found in the empty JSON string", RebalancingConditions.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<RebalancingConditions>() {
           ...
           public RebalancingConditions read(JsonReader in) throws IOException {
             ...
             RebalancingConditions instance = thisAdapter.fromJsonTree(jsonObj);
