...
public class ReverseSplitActivityV2 implements Serializable {
  ...
  public ReverseSplitActivityV2() {
  }

  public ReverseSplitActivityV2 groupId(@javax.annotation.Nullable UUID groupId) {
  ...
  public ReverseSplitActivityV2 systemDate(@javax.annotation.Nonnull LocalDate systemDate) {
  ...
  public ReverseSplitActivityV2 caId(@javax.annotation.Nullable UUID caId) {
    this.caId = caId;
    return this;
  }
  ...
  public ReverseSplitActivityV2 positionDate(@javax.annotation.Nonnull LocalDate positionDate) {
  ...
  public ReverseSplitActivityV2 reorgId(@javax.annotation.Nullable String reorgId) {
  ...
  public ReverseSplitActivityV2 newCusip(@javax.annotation.Nonnull String newCusip) {
  ...
  public ReverseSplitActivityV2 newIsin(@javax.annotation.Nullable String newIsin) {
  ...
  public ReverseSplitActivityV2 newRate(@javax.annotation.Nonnull String newRate) {
  ...
  public ReverseSplitActivityV2 oldCusip(@javax.annotation.Nonnull String oldCusip) {
  ...
  public ReverseSplitActivityV2 oldIsin(@javax.annotation.Nullable String oldIsin) {
  ...
  public ReverseSplitActivityV2 oldRate(@javax.annotation.Nonnull String oldRate) {
  ...
  public ReverseSplitActivityV2 payableDate(@javax.annotation.Nullable LocalDate payableDate) {
  ...
  public ReverseSplitActivityV2 newQty(@javax.annotation.Nonnull String newQty) {
    this.newQty = newQty;
    return this;
  }
  ...
  public ReverseSplitActivityV2 oldQty(@javax.annotation.Nonnull String oldQty) {
    this.oldQty = oldQty;
    return this;
  }
  ...
  public ReverseSplitActivityV2 exDate(@javax.annotation.Nullable LocalDate exDate) {
    this.exDate = exDate;
    return this;
  }
  ...
  public ReverseSplitActivityV2 newSymbol(@javax.annotation.Nullable String newSymbol) {
  ...
  public ReverseSplitActivityV2 recordDate(@javax.annotation.Nullable LocalDate recordDate) {
  ...
  public ReverseSplitActivityV2 symbol(@javax.annotation.Nonnull String symbol) {
    this.symbol = symbol;
    return this;
  }
   ...
   * @return the ReverseSplitActivityV2 instance itself
   */
  public ReverseSplitActivityV2 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ReverseSplitActivityV2 reverseSplitActivityV2 = (ReverseSplitActivityV2) o;
    return Objects.equals(this.groupId, reverseSplitActivityV2.groupId) &&
        Objects.equals(this.systemDate, reverseSplitActivityV2.systemDate) &&
        Objects.equals(this.caId, reverseSplitActivityV2.caId) &&
        Objects.equals(this.positionDate, reverseSplitActivityV2.positionDate) &&
        Objects.equals(this.reorgId, reverseSplitActivityV2.reorgId) &&
        Objects.equals(this.newCusip, reverseSplitActivityV2.newCusip) &&
        Objects.equals(this.newIsin, reverseSplitActivityV2.newIsin) &&
        Objects.equals(this.newRate, reverseSplitActivityV2.newRate) &&
        Objects.equals(this.oldCusip, reverseSplitActivityV2.oldCusip) &&
        Objects.equals(this.oldIsin, reverseSplitActivityV2.oldIsin) &&
        Objects.equals(this.oldRate, reverseSplitActivityV2.oldRate) &&
        Objects.equals(this.payableDate, reverseSplitActivityV2.payableDate) &&
        Objects.equals(this.newQty, reverseSplitActivityV2.newQty) &&
        Objects.equals(this.oldQty, reverseSplitActivityV2.oldQty) &&
        Objects.equals(this.exDate, reverseSplitActivityV2.exDate) &&
        Objects.equals(this.newSymbol, reverseSplitActivityV2.newSymbol) &&
        Objects.equals(this.recordDate, reverseSplitActivityV2.recordDate) &&
        Objects.equals(this.symbol, reverseSplitActivityV2.symbol)&&
        Objects.equals(this.additionalProperties, reverseSplitActivityV2.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(groupId, systemDate, caId, positionDate, reorgId, newCusip, newIsin, newRate, oldCusip, oldIsin, oldRate, payableDate, newQty, oldQty, exDate, newSymbol, recordDate, symbol, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ReverseSplitActivityV2 {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("group_id", "system_date", "ca_id", "position_date", "reorg_id", "new_cusip", "new_isin", "new_rate", "old_cusip", "old_isin", "old_rate", "payable_date", "new_qty", "old_qty", "ex_date", "new_symbol", "record_date", "symbol"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to ReverseSplitActivityV2
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ReverseSplitActivityV2.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ReverseSplitActivityV2 is not found in the empty JSON string", ReverseSplitActivityV2.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ReverseSplitActivityV2.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReverseSplitActivityV2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReverseSplitActivityV2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReverseSplitActivityV2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReverseSplitActivityV2.class));

       return (TypeAdapter<T>) new TypeAdapter<ReverseSplitActivityV2>() {
           @Override
           public void write(JsonWriter out, ReverseSplitActivityV2 value) throws IOException {
           ...
           @Override
           public ReverseSplitActivityV2 read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ReverseSplitActivityV2 instance = thisAdapter.fromJsonTree(jsonObj);
   ...
   * @return An instance of ReverseSplitActivityV2
   * @throws IOException if the JSON string is invalid with respect to ReverseSplitActivityV2
   */
  public static ReverseSplitActivityV2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReverseSplitActivityV2.class);
  }
