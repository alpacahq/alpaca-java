...
public class OPTRDActivityV2 implements Serializable {
  ...
  public OPTRDActivityV2() {
  }

  public OPTRDActivityV2 contractSymbol(@javax.annotation.Nullable String contractSymbol) {
  ...
  public OPTRDActivityV2 cusip(@javax.annotation.Nullable String cusip) {
    this.cusip = cusip;
    return this;
  }
  ...
  public OPTRDActivityV2 symbol(@javax.annotation.Nullable String symbol) {
    this.symbol = symbol;
    return this;
  }
  ...
  public OPTRDActivityV2 groupId(@javax.annotation.Nullable UUID groupId) {
  ...
  public OPTRDActivityV2 systemDate(@javax.annotation.Nonnull LocalDate systemDate) {
   ...
   * @return the OPTRDActivityV2 instance itself
   */
  public OPTRDActivityV2 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    OPTRDActivityV2 opTRDActivityV2 = (OPTRDActivityV2) o;
    return Objects.equals(this.contractSymbol, opTRDActivityV2.contractSymbol) &&
        Objects.equals(this.cusip, opTRDActivityV2.cusip) &&
        Objects.equals(this.symbol, opTRDActivityV2.symbol) &&
        Objects.equals(this.groupId, opTRDActivityV2.groupId) &&
        Objects.equals(this.systemDate, opTRDActivityV2.systemDate)&&
        Objects.equals(this.additionalProperties, opTRDActivityV2.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class OPTRDActivityV2 {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to OPTRDActivityV2
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OPTRDActivityV2.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in OPTRDActivityV2 is not found in the empty JSON string", OPTRDActivityV2.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OPTRDActivityV2.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OPTRDActivityV2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OPTRDActivityV2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OPTRDActivityV2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OPTRDActivityV2.class));

       return (TypeAdapter<T>) new TypeAdapter<OPTRDActivityV2>() {
           @Override
           public void write(JsonWriter out, OPTRDActivityV2 value) throws IOException {
           ...
           @Override
           public OPTRDActivityV2 read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             OPTRDActivityV2 instance = thisAdapter.fromJsonTree(jsonObj);
   ...
   * @return An instance of OPTRDActivityV2
   * @throws IOException if the JSON string is invalid with respect to OPTRDActivityV2
   */
  public static OPTRDActivityV2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OPTRDActivityV2.class);
  }
