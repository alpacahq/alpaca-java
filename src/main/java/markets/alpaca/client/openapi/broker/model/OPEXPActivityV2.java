...
public class OPEXPActivityV2 implements Serializable {
  ...
  public OPEXPActivityV2() {
  }

  public OPEXPActivityV2 contractSymbol(@javax.annotation.Nullable String contractSymbol) {
  ...
  public OPEXPActivityV2 cusip(@javax.annotation.Nullable String cusip) {
    this.cusip = cusip;
    return this;
  }
  ...
  public OPEXPActivityV2 symbol(@javax.annotation.Nullable String symbol) {
    this.symbol = symbol;
    return this;
  }
  ...
  public OPEXPActivityV2 groupId(@javax.annotation.Nullable UUID groupId) {
  ...
  public OPEXPActivityV2 systemDate(@javax.annotation.Nonnull LocalDate systemDate) {
   ...
   * @return the OPEXPActivityV2 instance itself
   */
  public OPEXPActivityV2 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    OPEXPActivityV2 opEXPActivityV2 = (OPEXPActivityV2) o;
    return Objects.equals(this.contractSymbol, opEXPActivityV2.contractSymbol) &&
        Objects.equals(this.cusip, opEXPActivityV2.cusip) &&
        Objects.equals(this.symbol, opEXPActivityV2.symbol) &&
        Objects.equals(this.groupId, opEXPActivityV2.groupId) &&
        Objects.equals(this.systemDate, opEXPActivityV2.systemDate)&&
        Objects.equals(this.additionalProperties, opEXPActivityV2.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class OPEXPActivityV2 {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to OPEXPActivityV2
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OPEXPActivityV2.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in OPEXPActivityV2 is not found in the empty JSON string", OPEXPActivityV2.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OPEXPActivityV2.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OPEXPActivityV2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OPEXPActivityV2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OPEXPActivityV2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OPEXPActivityV2.class));

       return (TypeAdapter<T>) new TypeAdapter<OPEXPActivityV2>() {
           @Override
           public void write(JsonWriter out, OPEXPActivityV2 value) throws IOException {
           ...
           @Override
           public OPEXPActivityV2 read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             OPEXPActivityV2 instance = thisAdapter.fromJsonTree(jsonObj);
   ...
   * @return An instance of OPEXPActivityV2
   * @throws IOException if the JSON string is invalid with respect to OPEXPActivityV2
   */
  public static OPEXPActivityV2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OPEXPActivityV2.class);
  }
