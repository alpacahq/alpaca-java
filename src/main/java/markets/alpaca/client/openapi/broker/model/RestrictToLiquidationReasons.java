...
public class RestrictToLiquidationReasons implements Serializable {
  ...
  public RestrictToLiquidationReasons achReturn(@javax.annotation.Nullable Boolean achReturn) {
  ...
  public void setAchReturn(@javax.annotation.Nullable Boolean achReturn) {
    this.achReturn = achReturn;
  }


  public RestrictToLiquidationReasons positionToEquityRatio(@javax.annotation.Nullable Boolean positionToEquityRatio) {
  ...
  public void setPositionToEquityRatio(@javax.annotation.Nullable Boolean positionToEquityRatio) {
    this.positionToEquityRatio = positionToEquityRatio;
  }


  public RestrictToLiquidationReasons unspecified(@javax.annotation.Nullable Boolean unspecified) {
  ...
  public void setUnspecified(@javax.annotation.Nullable Boolean unspecified) {
    this.unspecified = unspecified;
  }
   ...
   * @return the RestrictToLiquidationReasons instance itself
   */
  public RestrictToLiquidationReasons putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.achReturn, restrictToLiquidationReasons.achReturn) &&
        ...
        Objects.equals(this.additionalProperties, restrictToLiquidationReasons.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(achReturn, positionToEquityRatio, unspecified, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("ach_return", "position_to_equity_ratio", "unspecified"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to RestrictToLiquidationReasons
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RestrictToLiquidationReasons.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RestrictToLiquidationReasons is not found in the empty JSON string", RestrictToLiquidationReasons.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<RestrictToLiquidationReasons>() {
           ...
           public RestrictToLiquidationReasons read(JsonReader in) throws IOException {
             ...
             RestrictToLiquidationReasons instance = thisAdapter.fromJsonTree(jsonObj);
