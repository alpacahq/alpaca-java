...
public class EventsApi {
     ...
     * @param sinceId  (optional)
     * @param untilId  (optional)
     * @return List&lt;StatusFundingEvent&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
     ...
     */
    public List<StatusFundingEvent> subscribeToFundingStatusSSE(@javax.annotation.Nullable LocalDate since, @javax.annotation.Nullable LocalDate until, @javax.annotation.Nullable String sinceId, @javax.annotation.Nullable String untilId) throws ApiException {
        ApiResponse<List<StatusFundingEvent>> localVarResp = subscribeToFundingStatusSSEWithHttpInfo(since, until, sinceId, untilId);
        return localVarResp.getData();
    }
     ...
     * @param sinceId  (optional)
     * @param untilId  (optional)
     * @return ApiResponse&lt;List&lt;StatusFundingEvent&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
     ...
     */
    public ApiResponse<List<StatusFundingEvent>> subscribeToFundingStatusSSEWithHttpInfo(@javax.annotation.Nullable LocalDate since, @javax.annotation.Nullable LocalDate until, @javax.annotation.Nullable String sinceId, @javax.annotation.Nullable String untilId) throws ApiException {
        okhttp3.Call localVarCall = subscribeToFundingStatusSSEValidateBeforeCall(since, until, sinceId, untilId, null);
        Type localVarReturnType = new TypeToken<List<StatusFundingEvent>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call subscribeToFundingStatusSSEAsync(@javax.annotation.Nullable LocalDate since, @javax.annotation.Nullable LocalDate until, @javax.annotation.Nullable String sinceId, @javax.annotation.Nullable String untilId, final ApiCallback<List<StatusFundingEvent>> _callback) throws ApiException {
