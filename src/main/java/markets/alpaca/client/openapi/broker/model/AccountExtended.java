...
public class AccountExtended implements Serializable {
  ...
  public AccountExtended enabledAssets(@javax.annotation.Nullable List<EnabledAssetClass> enabledAssets) {
    this.enabledAssets = enabledAssets;
    return this;
  }

  public AccountExtended addEnabledAssetsItem(EnabledAssetClass enabledAssetsItem) {
