...
public class JournalStatusEvent implements Serializable {
  ...
  public JournalStatusEvent at(@javax.annotation.Nonnull OffsetDateTime at) {
    this.at = at;
    return this;
  }
  ...
  public JournalStatusEvent entryType(@javax.annotation.Nonnull JournalEntryType entryType) {
  ...
  public JournalStatusEvent eventId(@javax.annotation.Nullable Integer eventId) {
  ...
  public JournalStatusEvent eventUlid(@javax.annotation.Nonnull String eventUlid) {
  ...
  public JournalStatusEvent journalId(@javax.annotation.Nonnull UUID journalId) {
  ...
  public JournalStatusEvent statusTo(@javax.annotation.Nonnull JournalStatus statusTo) {
   ...
   * @return the JournalStatusEvent instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.at, journalStatusEvent.at) &&
        ...
        Objects.equals(this.additionalProperties, journalStatusEvent.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(at, entryType, eventId, eventUlid, journalId, statusFrom, statusTo, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("at", "entry_type", "event_id", "event_ulid", "journal_id", "status_from", "status_to"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("at", "entry_type", "event_ulid", "journal_id", "status_from", "status_to"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to JournalStatusEvent
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!JournalStatusEvent.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in JournalStatusEvent is not found in the empty JSON string", JournalStatusEvent.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<JournalStatusEvent>() {
           ...
           public JournalStatusEvent read(JsonReader in) throws IOException {
             ...
             JournalStatusEvent instance = thisAdapter.fromJsonTree(jsonObj);
