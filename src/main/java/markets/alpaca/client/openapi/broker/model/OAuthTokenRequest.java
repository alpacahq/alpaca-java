...
public class OAuthTokenRequest implements Serializable {
  ...
  public OAuthTokenRequest accountId(@javax.annotation.Nonnull UUID accountId) {
  ...
  public OAuthTokenRequest redirectUri(@javax.annotation.Nonnull String redirectUri) {
  ...
  public OAuthTokenRequest scope(@javax.annotation.Nonnull String scope) {
    this.scope = scope;
    return this;
  }
   ...
   * @return the OAuthTokenRequest instance itself
   */
  public OAuthTokenRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountId, oauthTokenRequest.accountId) &&
        ...
        Objects.equals(this.additionalProperties, oauthTokenRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountId, clientId, clientSecret, redirectUri, scope, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("account_id", "client_id", "client_secret", "redirect_uri", "scope"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("account_id", "client_id", "client_secret", "redirect_uri", "scope"));
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<OAuthTokenRequest>() {
           ...
           public OAuthTokenRequest read(JsonReader in) throws IOException {
             ...
             OAuthTokenRequest instance = thisAdapter.fromJsonTree(jsonObj);
