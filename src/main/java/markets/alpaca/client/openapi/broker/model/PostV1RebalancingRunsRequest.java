...
public class PostV1RebalancingRunsRequest implements Serializable {
   ...
   * @return the PostV1RebalancingRunsRequest instance itself
   */
  public PostV1RebalancingRunsRequest putAdditionalProperty(String key, Object value) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to PostV1RebalancingRunsRequest
   */
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<PostV1RebalancingRunsRequest>() {
           ...
           public PostV1RebalancingRunsRequest read(JsonReader in) throws IOException {
             ...
             PostV1RebalancingRunsRequest instance = thisAdapter.fromJsonTree(jsonObj);
