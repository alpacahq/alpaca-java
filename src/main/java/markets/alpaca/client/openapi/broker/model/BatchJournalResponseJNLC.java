...
/**
 * A cash journal result returned by the forward batch endpoint.
 */
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.24.0")
public class BatchJournalResponseJNLC implements Serializable {
  ...
  /**
   * Cash journal discriminator value.
   */
  ...
  public BatchJournalResponseJNLC() {
  }

  public BatchJournalResponseJNLC createdAt(@javax.annotation.Nullable OffsetDateTime createdAt) {
  ...
  public BatchJournalResponseJNLC currency(@javax.annotation.Nonnull String currency) {
  ...
  public BatchJournalResponseJNLC description(@javax.annotation.Nonnull String description) {
  ...
  public BatchJournalResponseJNLC fromAccount(@javax.annotation.Nonnull UUID fromAccount) {
  ...
  public BatchJournalResponseJNLC id(@javax.annotation.Nonnull UUID id) {
    this.id = id;
    return this;
  }
  ...
  public BatchJournalResponseJNLC netAmount(@javax.annotation.Nonnull BigDecimal netAmount) {
  ...
  public BatchJournalResponseJNLC price(@javax.annotation.Nonnull BigDecimal price) {
    this.price = price;
    return this;
  }
  ...
  public BatchJournalResponseJNLC qty(@javax.annotation.Nonnull BigDecimal qty) {
    this.qty = qty;
    return this;
  }
  ...
  public BatchJournalResponseJNLC settleDate(@javax.annotation.Nonnull LocalDate settleDate) {
  ...
  public BatchJournalResponseJNLC status(@javax.annotation.Nonnull JournalStatus status) {
    this.status = status;
    return this;
  }
  ...
  public BatchJournalResponseJNLC symbol(@javax.annotation.Nonnull String symbol) {
    this.symbol = symbol;
    return this;
  }
  ...
  public BatchJournalResponseJNLC systemDate(@javax.annotation.Nonnull LocalDate systemDate) {
  ...
  public BatchJournalResponseJNLC toAccount(@javax.annotation.Nonnull UUID toAccount) {
  ...
  public BatchJournalResponseJNLC transmitterInfo(@javax.annotation.Nullable TransmitterInfo transmitterInfo) {
  ...
  public BatchJournalResponseJNLC entryType(@javax.annotation.Nonnull EntryTypeEnum entryType) {
  ...
  public BatchJournalResponseJNLC transmitterAccountNumber(@javax.annotation.Nullable String transmitterAccountNumber) {
    this.transmitterAccountNumber = transmitterAccountNumber;
    return this;
  }

  /**
   * Optional for JNLC journals. Maximum 255 characters. See more details about [Travel Rule](https://alpaca.markets/docs/broker/integration/funding/#travel-rule) in our main documentation.
  ...
  public BatchJournalResponseJNLC transmitterAddress(@javax.annotation.Nullable String transmitterAddress) {
  ...
  public BatchJournalResponseJNLC transmitterFinancialInstitution(@javax.annotation.Nullable String transmitterFinancialInstitution) {
  ...
  public BatchJournalResponseJNLC transmitterName(@javax.annotation.Nullable String transmitterName) {
  ...
  public BatchJournalResponseJNLC transmitterTimestamp(@javax.annotation.Nullable OffsetDateTime transmitterTimestamp) {
    this.transmitterTimestamp = transmitterTimestamp;
    return this;
  }

  /**
   * Optional for JNLC journals. RFC 3339 format. See more details about [Travel Rule](https://alpaca.markets/docs/broker/integration/funding/#travel-rule) in our main documentation.
  ...
  public BatchJournalResponseJNLC errorMessage(@javax.annotation.Nullable String errorMessage) {
    this.errorMessage = errorMessage;
    return this;
  }

  /**
   * Description of why this journal transaction failed. Omitted for successful results.
   * @return errorMessage
   */
  @javax.annotation.Nullable
   ...
   * @return the BatchJournalResponseJNLC instance itself
   */
  public BatchJournalResponseJNLC putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    BatchJournalResponseJNLC batchJournalResponseJNLC = (BatchJournalResponseJNLC) o;
    return Objects.equals(this.createdAt, batchJournalResponseJNLC.createdAt) &&
        Objects.equals(this.currency, batchJournalResponseJNLC.currency) &&
        Objects.equals(this.description, batchJournalResponseJNLC.description) &&
        Objects.equals(this.fromAccount, batchJournalResponseJNLC.fromAccount) &&
        Objects.equals(this.id, batchJournalResponseJNLC.id) &&
        Objects.equals(this.netAmount, batchJournalResponseJNLC.netAmount) &&
        Objects.equals(this.price, batchJournalResponseJNLC.price) &&
        Objects.equals(this.qty, batchJournalResponseJNLC.qty) &&
        Objects.equals(this.settleDate, batchJournalResponseJNLC.settleDate) &&
        Objects.equals(this.status, batchJournalResponseJNLC.status) &&
        Objects.equals(this.symbol, batchJournalResponseJNLC.symbol) &&
        Objects.equals(this.systemDate, batchJournalResponseJNLC.systemDate) &&
        Objects.equals(this.toAccount, batchJournalResponseJNLC.toAccount) &&
        Objects.equals(this.transmitterInfo, batchJournalResponseJNLC.transmitterInfo) &&
        Objects.equals(this.entryType, batchJournalResponseJNLC.entryType) &&
        Objects.equals(this.transmitterAccountNumber, batchJournalResponseJNLC.transmitterAccountNumber) &&
        Objects.equals(this.transmitterAddress, batchJournalResponseJNLC.transmitterAddress) &&
        Objects.equals(this.transmitterFinancialInstitution, batchJournalResponseJNLC.transmitterFinancialInstitution) &&
        Objects.equals(this.transmitterName, batchJournalResponseJNLC.transmitterName) &&
        Objects.equals(this.transmitterTimestamp, batchJournalResponseJNLC.transmitterTimestamp) &&
        Objects.equals(this.errorMessage, batchJournalResponseJNLC.errorMessage)&&
        Objects.equals(this.additionalProperties, batchJournalResponseJNLC.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(createdAt, currency, description, fromAccount, id, netAmount, price, qty, settleDate, status, symbol, systemDate, toAccount, transmitterInfo, entryType, transmitterAccountNumber, transmitterAddress, transmitterFinancialInstitution, transmitterName, transmitterTimestamp, errorMessage, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class BatchJournalResponseJNLC {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("created_at", "currency", "description", "from_account", "id", "net_amount", "price", "qty", "settle_date", "status", "symbol", "system_date", "to_account", "transmitter_info", "entry_type", "transmitter_account_number", "transmitter_address", "transmitter_financial_institution", "transmitter_name", "transmitter_timestamp", "error_message"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to BatchJournalResponseJNLC
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BatchJournalResponseJNLC.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in BatchJournalResponseJNLC is not found in the empty JSON string", BatchJournalResponseJNLC.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : BatchJournalResponseJNLC.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BatchJournalResponseJNLC.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BatchJournalResponseJNLC' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BatchJournalResponseJNLC> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BatchJournalResponseJNLC.class));

       return (TypeAdapter<T>) new TypeAdapter<BatchJournalResponseJNLC>() {
           @Override
           public void write(JsonWriter out, BatchJournalResponseJNLC value) throws IOException {
           ...
           @Override
           public BatchJournalResponseJNLC read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             BatchJournalResponseJNLC instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of BatchJournalResponseJNLC given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BatchJournalResponseJNLC
   * @throws IOException if the JSON string is invalid with respect to BatchJournalResponseJNLC
   */
  public static BatchJournalResponseJNLC fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BatchJournalResponseJNLC.class);
  }

  /**
   * Convert an instance of BatchJournalResponseJNLC to an JSON string
   *
   * @return JSON string
   */
