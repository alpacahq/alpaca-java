...
public class OPASNActivityV2 implements Serializable {
  ...
  public OPASNActivityV2() {
  }

  public OPASNActivityV2 contractSymbol(@javax.annotation.Nullable String contractSymbol) {
  ...
  public OPASNActivityV2 cusip(@javax.annotation.Nullable String cusip) {
    this.cusip = cusip;
    return this;
  }
  ...
  public OPASNActivityV2 symbol(@javax.annotation.Nullable String symbol) {
    this.symbol = symbol;
    return this;
  }
  ...
  public OPASNActivityV2 groupId(@javax.annotation.Nullable UUID groupId) {
  ...
  public OPASNActivityV2 systemDate(@javax.annotation.Nonnull LocalDate systemDate) {
   ...
   * @return the OPASNActivityV2 instance itself
   */
  public OPASNActivityV2 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    OPASNActivityV2 opASNActivityV2 = (OPASNActivityV2) o;
    return Objects.equals(this.contractSymbol, opASNActivityV2.contractSymbol) &&
        Objects.equals(this.cusip, opASNActivityV2.cusip) &&
        Objects.equals(this.symbol, opASNActivityV2.symbol) &&
        Objects.equals(this.groupId, opASNActivityV2.groupId) &&
        Objects.equals(this.systemDate, opASNActivityV2.systemDate)&&
        Objects.equals(this.additionalProperties, opASNActivityV2.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class OPASNActivityV2 {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to OPASNActivityV2
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OPASNActivityV2.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in OPASNActivityV2 is not found in the empty JSON string", OPASNActivityV2.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OPASNActivityV2.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OPASNActivityV2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OPASNActivityV2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OPASNActivityV2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OPASNActivityV2.class));

       return (TypeAdapter<T>) new TypeAdapter<OPASNActivityV2>() {
           @Override
           public void write(JsonWriter out, OPASNActivityV2 value) throws IOException {
           ...
           @Override
           public OPASNActivityV2 read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             OPASNActivityV2 instance = thisAdapter.fromJsonTree(jsonObj);
   ...
   * @return An instance of OPASNActivityV2
   * @throws IOException if the JSON string is invalid with respect to OPASNActivityV2
   */
  public static OPASNActivityV2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OPASNActivityV2.class);
  }
