...
public class GetV1ReportingEodPositions200Response implements Serializable {
  ...
  public GetV1ReportingEodPositions200Response asof(@javax.annotation.Nullable LocalDate asof) {
    this.asof = asof;
    return this;
  }
  ...
  public GetV1ReportingEodPositions200Response nextPageToken(@javax.annotation.Nullable String nextPageToken) {
  ...
  public GetV1ReportingEodPositions200Response positions(@javax.annotation.Nullable Map<String, List<Position>> positions) {
  ...
  public void setPositions(@javax.annotation.Nullable Map<String, List<Position>> positions) {
    this.positions = positions;
  }
   ...
   * @return the GetV1ReportingEodPositions200Response instance itself
   */
  public GetV1ReportingEodPositions200Response putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.asof, getV1ReportingEodPositions200Response.asof) &&
        ...
        Objects.equals(this.additionalProperties, getV1ReportingEodPositions200Response.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(asof, nextPageToken, positions, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("asof", "next_page_token", "positions"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetV1ReportingEodPositions200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetV1ReportingEodPositions200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GetV1ReportingEodPositions200Response is not found in the empty JSON string", GetV1ReportingEodPositions200Response.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<GetV1ReportingEodPositions200Response>() {
           ...
           public GetV1ReportingEodPositions200Response read(JsonReader in) throws IOException {
             ...
             GetV1ReportingEodPositions200Response instance = thisAdapter.fromJsonTree(jsonObj);
