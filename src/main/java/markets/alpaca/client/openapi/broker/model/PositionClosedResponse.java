...
public class PositionClosedResponse implements Serializable {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(body, status, symbol, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("body", "status", "symbol"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("status", "symbol"));
  }
