...
import markets.alpaca.client.openapi.data.model.StockDailyAuctions;
...
public class StockAuctionsRespSingle implements Serializable {
  ...
  public StockAuctionsRespSingle auctions(@javax.annotation.Nonnull List<StockDailyAuctions> auctions) {
  ...
  public void setAuctions(@javax.annotation.Nonnull List<StockDailyAuctions> auctions) {
    this.auctions = auctions;
  }


  public StockAuctionsRespSingle currency(@javax.annotation.Nullable String currency) {
  ...
  public StockAuctionsRespSingle nextPageToken(@javax.annotation.Nullable String nextPageToken) {
  ...
  public StockAuctionsRespSingle symbol(@javax.annotation.Nonnull String symbol) {
    this.symbol = symbol;
    return this;
  }
   ...
   * @return the StockAuctionsRespSingle instance itself
   */
  public StockAuctionsRespSingle putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.auctions, stockAuctionsRespSingle.auctions) &&
        ...
        Objects.equals(this.symbol, stockAuctionsRespSingle.symbol)&&
        Objects.equals(this.additionalProperties, stockAuctionsRespSingle.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(auctions, currency, nextPageToken, symbol, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("auctions", "currency", "next_page_token", "symbol"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("auctions", "next_page_token", "symbol"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to StockAuctionsRespSingle
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StockAuctionsRespSingle.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in StockAuctionsRespSingle is not found in the empty JSON string", StockAuctionsRespSingle.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("auctions") != null) {
        if (!jsonObj.get("auctions").isJsonArray()) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `auctions` to be an array in the JSON string but got `%s`", jsonObj.get("auctions").toString()));
        }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<StockAuctionsRespSingle>() {
           ...
           public StockAuctionsRespSingle read(JsonReader in) throws IOException {
             ...
             StockAuctionsRespSingle instance = thisAdapter.fromJsonTree(jsonObj);
