...
public class Redemption implements Serializable {
  ...
  public Redemption currency(@javax.annotation.Nullable String currency) {
  ...
  public Redemption cusip(@javax.annotation.Nonnull String cusip) {
    this.cusip = cusip;
    return this;
  }
  ...
  public Redemption id(@javax.annotation.Nonnull UUID id) {
    this.id = id;
    return this;
  }
  ...
  public Redemption isin(@javax.annotation.Nullable String isin) {
    this.isin = isin;
    return this;
  }
  ...
  public Redemption payableDate(@javax.annotation.Nullable LocalDate payableDate) {
  ...
  public Redemption processDate(@javax.annotation.Nonnull LocalDate processDate) {
  ...
  public Redemption rate(@javax.annotation.Nonnull Double rate) {
    this.rate = rate;
    return this;
  }
  ...
  public Redemption symbol(@javax.annotation.Nonnull String symbol) {
    this.symbol = symbol;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.currency, redemption.currency) &&
        Objects.equals(this.cusip, redemption.cusip) &&
        Objects.equals(this.id, redemption.id) &&
        Objects.equals(this.isin, redemption.isin) &&
        Objects.equals(this.payableDate, redemption.payableDate) &&
        Objects.equals(this.processDate, redemption.processDate) &&
        Objects.equals(this.rate, redemption.rate) &&
        Objects.equals(this.symbol, redemption.symbol)&&
        Objects.equals(this.additionalProperties, redemption.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(currency, cusip, id, isin, payableDate, processDate, rate, symbol, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("currency", "cusip", "id", "isin", "payable_date", "process_date", "rate", "symbol"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("cusip", "id", "process_date", "rate", "symbol"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Redemption.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in Redemption is not found in the empty JSON string", Redemption.openapiRequiredFields.toString()));
        }
      }
