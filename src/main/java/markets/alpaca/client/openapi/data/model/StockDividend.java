...
public class StockDividend implements Serializable {
  ...
  public StockDividend currency(@javax.annotation.Nullable String currency) {
  ...
  public StockDividend cusip(@javax.annotation.Nonnull String cusip) {
    this.cusip = cusip;
    return this;
  }
  ...
  public StockDividend exDate(@javax.annotation.Nonnull LocalDate exDate) {
    this.exDate = exDate;
    return this;
  }
  ...
  public StockDividend id(@javax.annotation.Nonnull UUID id) {
    this.id = id;
    return this;
  }
  ...
  public StockDividend isin(@javax.annotation.Nullable String isin) {
    this.isin = isin;
    return this;
  }
  ...
  public StockDividend payableDate(@javax.annotation.Nullable LocalDate payableDate) {
  ...
  public StockDividend processDate(@javax.annotation.Nonnull LocalDate processDate) {
  ...
  public StockDividend rate(@javax.annotation.Nonnull Double rate) {
    this.rate = rate;
    return this;
  }
  ...
  public StockDividend recordDate(@javax.annotation.Nullable LocalDate recordDate) {
  ...
  public StockDividend symbol(@javax.annotation.Nonnull String symbol) {
    this.symbol = symbol;
    return this;
  }
   ...
   * @return the StockDividend instance itself
   */
  public StockDividend putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.currency, stockDividend.currency) &&
        Objects.equals(this.cusip, stockDividend.cusip) &&
        Objects.equals(this.exDate, stockDividend.exDate) &&
        Objects.equals(this.id, stockDividend.id) &&
        Objects.equals(this.isin, stockDividend.isin) &&
        Objects.equals(this.payableDate, stockDividend.payableDate) &&
        Objects.equals(this.processDate, stockDividend.processDate) &&
        Objects.equals(this.rate, stockDividend.rate) &&
        Objects.equals(this.recordDate, stockDividend.recordDate) &&
        Objects.equals(this.symbol, stockDividend.symbol)&&
        Objects.equals(this.additionalProperties, stockDividend.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(currency, cusip, exDate, id, isin, payableDate, processDate, rate, recordDate, symbol, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class StockDividend {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("currency", "cusip", "ex_date", "id", "isin", "payable_date", "process_date", "rate", "record_date", "symbol"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("cusip", "ex_date", "id", "process_date", "rate", "symbol"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to StockDividend
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StockDividend.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in StockDividend is not found in the empty JSON string", StockDividend.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : StockDividend.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StockDividend.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StockDividend' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StockDividend> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StockDividend.class));

       return (TypeAdapter<T>) new TypeAdapter<StockDividend>() {
           @Override
           public void write(JsonWriter out, StockDividend value) throws IOException {
           ...
           @Override
           public StockDividend read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             StockDividend instance = thisAdapter.fromJsonTree(jsonObj);
   ...
   * @return An instance of StockDividend
   * @throws IOException if the JSON string is invalid with respect to StockDividend
   */
  public static StockDividend fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StockDividend.class);
  }
