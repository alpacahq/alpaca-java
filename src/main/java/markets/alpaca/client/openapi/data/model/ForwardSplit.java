...
public class ForwardSplit implements Serializable {
  ...
  public ForwardSplit currency(@javax.annotation.Nullable String currency) {
  ...
  public ForwardSplit cusip(@javax.annotation.Nonnull String cusip) {
    this.cusip = cusip;
    return this;
  }
  ...
  public ForwardSplit dueBillRedemptionDate(@javax.annotation.Nullable LocalDate dueBillRedemptionDate) {
  ...
  public ForwardSplit exDate(@javax.annotation.Nonnull LocalDate exDate) {
    this.exDate = exDate;
    return this;
  }
  ...
  public ForwardSplit id(@javax.annotation.Nonnull UUID id) {
    this.id = id;
    return this;
  }
  ...
  public ForwardSplit isin(@javax.annotation.Nullable String isin) {
    this.isin = isin;
    return this;
  }
  ...
  public ForwardSplit newRate(@javax.annotation.Nonnull Double newRate) {
  ...
  public ForwardSplit oldRate(@javax.annotation.Nonnull Double oldRate) {
  ...
  public ForwardSplit payableDate(@javax.annotation.Nullable LocalDate payableDate) {
  ...
  public ForwardSplit processDate(@javax.annotation.Nonnull LocalDate processDate) {
  ...
  public ForwardSplit recordDate(@javax.annotation.Nullable LocalDate recordDate) {
  ...
  public ForwardSplit symbol(@javax.annotation.Nonnull String symbol) {
    this.symbol = symbol;
    return this;
  }
   ...
   * @return the ForwardSplit instance itself
   */
  public ForwardSplit putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ForwardSplit forwardSplit = (ForwardSplit) o;
    return Objects.equals(this.currency, forwardSplit.currency) &&
        Objects.equals(this.cusip, forwardSplit.cusip) &&
        Objects.equals(this.dueBillRedemptionDate, forwardSplit.dueBillRedemptionDate) &&
        Objects.equals(this.exDate, forwardSplit.exDate) &&
        Objects.equals(this.id, forwardSplit.id) &&
        Objects.equals(this.isin, forwardSplit.isin) &&
        Objects.equals(this.newRate, forwardSplit.newRate) &&
        Objects.equals(this.oldRate, forwardSplit.oldRate) &&
        Objects.equals(this.payableDate, forwardSplit.payableDate) &&
        Objects.equals(this.processDate, forwardSplit.processDate) &&
        Objects.equals(this.recordDate, forwardSplit.recordDate) &&
        Objects.equals(this.symbol, forwardSplit.symbol)&&
        Objects.equals(this.additionalProperties, forwardSplit.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(currency, cusip, dueBillRedemptionDate, exDate, id, isin, newRate, oldRate, payableDate, processDate, recordDate, symbol, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ForwardSplit {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("currency", "cusip", "due_bill_redemption_date", "ex_date", "id", "isin", "new_rate", "old_rate", "payable_date", "process_date", "record_date", "symbol"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("cusip", "ex_date", "id", "new_rate", "old_rate", "process_date", "symbol"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ForwardSplit
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ForwardSplit.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ForwardSplit is not found in the empty JSON string", ForwardSplit.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ForwardSplit.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ForwardSplit.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ForwardSplit' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ForwardSplit> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ForwardSplit.class));

       return (TypeAdapter<T>) new TypeAdapter<ForwardSplit>() {
           @Override
           public void write(JsonWriter out, ForwardSplit value) throws IOException {
           ...
           @Override
           public ForwardSplit read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ForwardSplit instance = thisAdapter.fromJsonTree(jsonObj);
   ...
   * @return An instance of ForwardSplit
   * @throws IOException if the JSON string is invalid with respect to ForwardSplit
   */
  public static ForwardSplit fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ForwardSplit.class);
  }
