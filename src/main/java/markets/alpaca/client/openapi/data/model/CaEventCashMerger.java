...
/**
 * Cash merger payload delivered when &#x60;event_type &#x3D;&#x3D; cash_merger_corporateaction_event&#x60;. Corresponds to &#x60;cash_mergers&#x60; on the REST [&#x60;GET /v1/corporate-actions&#x60;](#operation/CorporateActions) response, but every decimal field is emitted as a JSON string to preserve precision on the wire. 
 */
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.25.0")
public class CaEventCashMerger implements Serializable {
  ...
  public CaEventCashMerger() {
  }

  public CaEventCashMerger id(@javax.annotation.Nonnull UUID id) {
    this.id = id;
    return this;
  }
  ...
  public CaEventCashMerger processDate(@javax.annotation.Nonnull LocalDate processDate) {
  ...
  public CaEventCashMerger acquireeCusip(@javax.annotation.Nonnull String acquireeCusip) {
  ...
  public CaEventCashMerger acquireeIsin(@javax.annotation.Nullable String acquireeIsin) {
  ...
  public CaEventCashMerger acquireeSymbol(@javax.annotation.Nonnull String acquireeSymbol) {
  ...
  public CaEventCashMerger acquirerCusip(@javax.annotation.Nullable String acquirerCusip) {
  ...
  public CaEventCashMerger acquirerIsin(@javax.annotation.Nullable String acquirerIsin) {
  ...
  public CaEventCashMerger acquirerSymbol(@javax.annotation.Nullable String acquirerSymbol) {
  ...
  public CaEventCashMerger currency(@javax.annotation.Nullable String currency) {
  ...
  public CaEventCashMerger effectiveDate(@javax.annotation.Nonnull LocalDate effectiveDate) {
  ...
  public CaEventCashMerger payableDate(@javax.annotation.Nullable LocalDate payableDate) {
  ...
  public CaEventCashMerger rate(@javax.annotation.Nonnull String rate) {
    this.rate = rate;
    return this;
  }
   ...
   * @return the CaEventCashMerger instance itself
   */
  public CaEventCashMerger putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CaEventCashMerger caEventCashMerger = (CaEventCashMerger) o;
    return Objects.equals(this.id, caEventCashMerger.id) &&
        Objects.equals(this.processDate, caEventCashMerger.processDate) &&
        Objects.equals(this.acquireeCusip, caEventCashMerger.acquireeCusip) &&
        Objects.equals(this.acquireeIsin, caEventCashMerger.acquireeIsin) &&
        Objects.equals(this.acquireeSymbol, caEventCashMerger.acquireeSymbol) &&
        Objects.equals(this.acquirerCusip, caEventCashMerger.acquirerCusip) &&
        Objects.equals(this.acquirerIsin, caEventCashMerger.acquirerIsin) &&
        Objects.equals(this.acquirerSymbol, caEventCashMerger.acquirerSymbol) &&
        Objects.equals(this.currency, caEventCashMerger.currency) &&
        Objects.equals(this.effectiveDate, caEventCashMerger.effectiveDate) &&
        Objects.equals(this.payableDate, caEventCashMerger.payableDate) &&
        Objects.equals(this.rate, caEventCashMerger.rate)&&
        Objects.equals(this.additionalProperties, caEventCashMerger.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, processDate, acquireeCusip, acquireeIsin, acquireeSymbol, acquirerCusip, acquirerIsin, acquirerSymbol, currency, effectiveDate, payableDate, rate, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CaEventCashMerger {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("id", "process_date", "acquiree_cusip", "acquiree_isin", "acquiree_symbol", "acquirer_cusip", "acquirer_isin", "acquirer_symbol", "currency", "effective_date", "payable_date", "rate"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("id", "process_date", "acquiree_cusip", "acquiree_symbol", "effective_date", "rate"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CaEventCashMerger
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CaEventCashMerger.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CaEventCashMerger is not found in the empty JSON string", CaEventCashMerger.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CaEventCashMerger.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CaEventCashMerger.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CaEventCashMerger' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CaEventCashMerger> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CaEventCashMerger.class));

       return (TypeAdapter<T>) new TypeAdapter<CaEventCashMerger>() {
           @Override
           public void write(JsonWriter out, CaEventCashMerger value) throws IOException {
           ...
           @Override
           public CaEventCashMerger read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             CaEventCashMerger instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of CaEventCashMerger given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CaEventCashMerger
   * @throws IOException if the JSON string is invalid with respect to CaEventCashMerger
   */
  public static CaEventCashMerger fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CaEventCashMerger.class);
  }

  /**
   * Convert an instance of CaEventCashMerger to an JSON string
   *
   * @return JSON string
   */
