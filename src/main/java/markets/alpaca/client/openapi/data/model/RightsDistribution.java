...
public class RightsDistribution implements Serializable {
  ...
  public RightsDistribution currency(@javax.annotation.Nullable String currency) {
  ...
  public RightsDistribution exDate(@javax.annotation.Nonnull LocalDate exDate) {
    this.exDate = exDate;
    return this;
  }
  ...
  public RightsDistribution expirationDate(@javax.annotation.Nullable LocalDate expirationDate) {
  ...
  public RightsDistribution id(@javax.annotation.Nonnull UUID id) {
    this.id = id;
    return this;
  }
  ...
  public RightsDistribution newCusip(@javax.annotation.Nonnull String newCusip) {
  ...
  public RightsDistribution newIsin(@javax.annotation.Nullable String newIsin) {
  ...
  public RightsDistribution newSymbol(@javax.annotation.Nonnull String newSymbol) {
  ...
  public RightsDistribution payableDate(@javax.annotation.Nonnull LocalDate payableDate) {
  ...
  public RightsDistribution processDate(@javax.annotation.Nonnull LocalDate processDate) {
  ...
  public RightsDistribution rate(@javax.annotation.Nonnull Double rate) {
    this.rate = rate;
    return this;
  }
  ...
  public RightsDistribution recordDate(@javax.annotation.Nullable LocalDate recordDate) {
  ...
  public RightsDistribution sourceCusip(@javax.annotation.Nonnull String sourceCusip) {
  ...
  public RightsDistribution sourceIsin(@javax.annotation.Nullable String sourceIsin) {
  ...
  public RightsDistribution sourceSymbol(@javax.annotation.Nonnull String sourceSymbol) {
   ...
   * @return the RightsDistribution instance itself
   */
  public RightsDistribution putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    RightsDistribution rightsDistribution = (RightsDistribution) o;
    return Objects.equals(this.currency, rightsDistribution.currency) &&
        Objects.equals(this.exDate, rightsDistribution.exDate) &&
        Objects.equals(this.expirationDate, rightsDistribution.expirationDate) &&
        Objects.equals(this.id, rightsDistribution.id) &&
        Objects.equals(this.newCusip, rightsDistribution.newCusip) &&
        Objects.equals(this.newIsin, rightsDistribution.newIsin) &&
        Objects.equals(this.newSymbol, rightsDistribution.newSymbol) &&
        Objects.equals(this.payableDate, rightsDistribution.payableDate) &&
        Objects.equals(this.processDate, rightsDistribution.processDate) &&
        Objects.equals(this.rate, rightsDistribution.rate) &&
        Objects.equals(this.recordDate, rightsDistribution.recordDate) &&
        Objects.equals(this.sourceCusip, rightsDistribution.sourceCusip) &&
        Objects.equals(this.sourceIsin, rightsDistribution.sourceIsin) &&
        Objects.equals(this.sourceSymbol, rightsDistribution.sourceSymbol)&&
        Objects.equals(this.additionalProperties, rightsDistribution.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(currency, exDate, expirationDate, id, newCusip, newIsin, newSymbol, payableDate, processDate, rate, recordDate, sourceCusip, sourceIsin, sourceSymbol, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RightsDistribution {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("currency", "ex_date", "expiration_date", "id", "new_cusip", "new_isin", "new_symbol", "payable_date", "process_date", "rate", "record_date", "source_cusip", "source_isin", "source_symbol"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("ex_date", "id", "new_cusip", "new_symbol", "payable_date", "process_date", "rate", "source_cusip", "source_symbol"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to RightsDistribution
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RightsDistribution.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RightsDistribution is not found in the empty JSON string", RightsDistribution.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RightsDistribution.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RightsDistribution.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RightsDistribution' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RightsDistribution> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RightsDistribution.class));

       return (TypeAdapter<T>) new TypeAdapter<RightsDistribution>() {
           @Override
           public void write(JsonWriter out, RightsDistribution value) throws IOException {
           ...
           @Override
           public RightsDistribution read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             RightsDistribution instance = thisAdapter.fromJsonTree(jsonObj);
   ...
   * @return An instance of RightsDistribution
   * @throws IOException if the JSON string is invalid with respect to RightsDistribution
   */
  public static RightsDistribution fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RightsDistribution.class);
  }
