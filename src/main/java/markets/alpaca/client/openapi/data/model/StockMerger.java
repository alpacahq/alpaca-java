...
public class StockMerger implements Serializable {
  ...
  public StockMerger acquireeCusip(@javax.annotation.Nonnull String acquireeCusip) {
  ...
  public StockMerger acquireeIsin(@javax.annotation.Nullable String acquireeIsin) {
  ...
  public StockMerger acquireeRate(@javax.annotation.Nonnull Double acquireeRate) {
  ...
  public StockMerger acquireeSymbol(@javax.annotation.Nonnull String acquireeSymbol) {
  ...
  public StockMerger acquirerCusip(@javax.annotation.Nonnull String acquirerCusip) {
  ...
  public StockMerger acquirerIsin(@javax.annotation.Nullable String acquirerIsin) {
  ...
  public StockMerger acquirerRate(@javax.annotation.Nonnull Double acquirerRate) {
  ...
  public StockMerger acquirerSymbol(@javax.annotation.Nonnull String acquirerSymbol) {
  ...
  public StockMerger currency(@javax.annotation.Nullable String currency) {
  ...
  public StockMerger effectiveDate(@javax.annotation.Nonnull LocalDate effectiveDate) {
  ...
  public StockMerger id(@javax.annotation.Nonnull UUID id) {
    this.id = id;
    return this;
  }
  ...
  public StockMerger payableDate(@javax.annotation.Nullable LocalDate payableDate) {
  ...
  public StockMerger processDate(@javax.annotation.Nonnull LocalDate processDate) {
   ...
   * @return the StockMerger instance itself
   */
  public StockMerger putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    StockMerger stockMerger = (StockMerger) o;
    return Objects.equals(this.acquireeCusip, stockMerger.acquireeCusip) &&
        Objects.equals(this.acquireeIsin, stockMerger.acquireeIsin) &&
        Objects.equals(this.acquireeRate, stockMerger.acquireeRate) &&
        Objects.equals(this.acquireeSymbol, stockMerger.acquireeSymbol) &&
        Objects.equals(this.acquirerCusip, stockMerger.acquirerCusip) &&
        Objects.equals(this.acquirerIsin, stockMerger.acquirerIsin) &&
        Objects.equals(this.acquirerRate, stockMerger.acquirerRate) &&
        Objects.equals(this.acquirerSymbol, stockMerger.acquirerSymbol) &&
        Objects.equals(this.currency, stockMerger.currency) &&
        Objects.equals(this.effectiveDate, stockMerger.effectiveDate) &&
        Objects.equals(this.id, stockMerger.id) &&
        Objects.equals(this.payableDate, stockMerger.payableDate) &&
        Objects.equals(this.processDate, stockMerger.processDate)&&
        Objects.equals(this.additionalProperties, stockMerger.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(acquireeCusip, acquireeIsin, acquireeRate, acquireeSymbol, acquirerCusip, acquirerIsin, acquirerRate, acquirerSymbol, currency, effectiveDate, id, payableDate, processDate, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class StockMerger {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("acquiree_cusip", "acquiree_isin", "acquiree_rate", "acquiree_symbol", "acquirer_cusip", "acquirer_isin", "acquirer_rate", "acquirer_symbol", "currency", "effective_date", "id", "payable_date", "process_date"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("acquiree_cusip", "acquiree_rate", "acquiree_symbol", "acquirer_cusip", "acquirer_rate", "acquirer_symbol", "effective_date", "id", "process_date"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to StockMerger
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StockMerger.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in StockMerger is not found in the empty JSON string", StockMerger.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : StockMerger.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StockMerger.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StockMerger' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StockMerger> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StockMerger.class));

       return (TypeAdapter<T>) new TypeAdapter<StockMerger>() {
           @Override
           public void write(JsonWriter out, StockMerger value) throws IOException {
           ...
           @Override
           public StockMerger read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             StockMerger instance = thisAdapter.fromJsonTree(jsonObj);
   ...
   * @return An instance of StockMerger
   * @throws IOException if the JSON string is invalid with respect to StockMerger
   */
  public static StockMerger fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StockMerger.class);
  }
