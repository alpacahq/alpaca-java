...
import markets.alpaca.client.openapi.data.model.CryptoOrderbook;
...
public class CryptoLatestOrderbooksResp implements Serializable {
  ...
  public CryptoLatestOrderbooksResp orderbooks(@javax.annotation.Nonnull Map<String, CryptoOrderbook> orderbooks) {
  ...
  public void setOrderbooks(@javax.annotation.Nonnull Map<String, CryptoOrderbook> orderbooks) {
    this.orderbooks = orderbooks;
  }
   ...
   * @return the CryptoLatestOrderbooksResp instance itself
   */
  public CryptoLatestOrderbooksResp putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.orderbooks, cryptoLatestOrderbooksResp.orderbooks)&&
        Objects.equals(this.additionalProperties, cryptoLatestOrderbooksResp.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(orderbooks, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("orderbooks"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("orderbooks"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CryptoLatestOrderbooksResp
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CryptoLatestOrderbooksResp.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CryptoLatestOrderbooksResp is not found in the empty JSON string", CryptoLatestOrderbooksResp.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CryptoLatestOrderbooksResp>() {
           ...
           public CryptoLatestOrderbooksResp read(JsonReader in) throws IOException {
             ...
             CryptoLatestOrderbooksResp instance = thisAdapter.fromJsonTree(jsonObj);
