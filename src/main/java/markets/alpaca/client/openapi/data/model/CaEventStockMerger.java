...
/**
 * All-stock merger payload delivered when &#x60;event_type &#x3D;&#x3D; stock_merger_corporateaction_event&#x60;. Corresponds to &#x60;stock_mergers&#x60; on the REST [&#x60;GET /v1/corporate-actions&#x60;](#operation/CorporateActions) response, but every decimal field is emitted as a JSON string to preserve precision on the wire. 
 */
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.25.0")
public class CaEventStockMerger implements Serializable {
  ...
  public CaEventStockMerger() {
  }

  public CaEventStockMerger id(@javax.annotation.Nonnull UUID id) {
    this.id = id;
    return this;
  }
  ...
  public CaEventStockMerger processDate(@javax.annotation.Nonnull LocalDate processDate) {
  ...
  public CaEventStockMerger acquireeCusip(@javax.annotation.Nonnull String acquireeCusip) {
  ...
  public CaEventStockMerger acquireeIsin(@javax.annotation.Nullable String acquireeIsin) {
  ...
  public CaEventStockMerger acquireeRate(@javax.annotation.Nonnull String acquireeRate) {
  ...
  public CaEventStockMerger acquireeSymbol(@javax.annotation.Nonnull String acquireeSymbol) {
  ...
  public CaEventStockMerger acquirerCusip(@javax.annotation.Nonnull String acquirerCusip) {
  ...
  public CaEventStockMerger acquirerIsin(@javax.annotation.Nullable String acquirerIsin) {
  ...
  public CaEventStockMerger acquirerRate(@javax.annotation.Nonnull String acquirerRate) {
    this.acquirerRate = acquirerRate;
    return this;
  }

  /**
   * Buyer-side ratio, as a decimal string.
   * @return acquirerRate
   */
  @javax.annotation.Nonnull
  ...
  public CaEventStockMerger acquirerSymbol(@javax.annotation.Nonnull String acquirerSymbol) {
  ...
  public CaEventStockMerger currency(@javax.annotation.Nullable String currency) {
  ...
  public CaEventStockMerger effectiveDate(@javax.annotation.Nonnull LocalDate effectiveDate) {
  ...
  public CaEventStockMerger payableDate(@javax.annotation.Nullable LocalDate payableDate) {
   ...
   * @return the CaEventStockMerger instance itself
   */
  public CaEventStockMerger putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CaEventStockMerger caEventStockMerger = (CaEventStockMerger) o;
    return Objects.equals(this.id, caEventStockMerger.id) &&
        Objects.equals(this.processDate, caEventStockMerger.processDate) &&
        Objects.equals(this.acquireeCusip, caEventStockMerger.acquireeCusip) &&
        Objects.equals(this.acquireeIsin, caEventStockMerger.acquireeIsin) &&
        Objects.equals(this.acquireeRate, caEventStockMerger.acquireeRate) &&
        Objects.equals(this.acquireeSymbol, caEventStockMerger.acquireeSymbol) &&
        Objects.equals(this.acquirerCusip, caEventStockMerger.acquirerCusip) &&
        Objects.equals(this.acquirerIsin, caEventStockMerger.acquirerIsin) &&
        Objects.equals(this.acquirerRate, caEventStockMerger.acquirerRate) &&
        Objects.equals(this.acquirerSymbol, caEventStockMerger.acquirerSymbol) &&
        Objects.equals(this.currency, caEventStockMerger.currency) &&
        Objects.equals(this.effectiveDate, caEventStockMerger.effectiveDate) &&
        Objects.equals(this.payableDate, caEventStockMerger.payableDate)&&
        Objects.equals(this.additionalProperties, caEventStockMerger.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, processDate, acquireeCusip, acquireeIsin, acquireeRate, acquireeSymbol, acquirerCusip, acquirerIsin, acquirerRate, acquirerSymbol, currency, effectiveDate, payableDate, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CaEventStockMerger {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("id", "process_date", "acquiree_cusip", "acquiree_isin", "acquiree_rate", "acquiree_symbol", "acquirer_cusip", "acquirer_isin", "acquirer_rate", "acquirer_symbol", "currency", "effective_date", "payable_date"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("id", "process_date", "acquiree_cusip", "acquiree_rate", "acquiree_symbol", "acquirer_cusip", "acquirer_rate", "acquirer_symbol", "effective_date"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CaEventStockMerger
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CaEventStockMerger.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CaEventStockMerger is not found in the empty JSON string", CaEventStockMerger.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CaEventStockMerger.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CaEventStockMerger.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CaEventStockMerger' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CaEventStockMerger> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CaEventStockMerger.class));

       return (TypeAdapter<T>) new TypeAdapter<CaEventStockMerger>() {
           @Override
           public void write(JsonWriter out, CaEventStockMerger value) throws IOException {
           ...
           @Override
           public CaEventStockMerger read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             CaEventStockMerger instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of CaEventStockMerger given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CaEventStockMerger
   * @throws IOException if the JSON string is invalid with respect to CaEventStockMerger
   */
  public static CaEventStockMerger fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CaEventStockMerger.class);
  }

  /**
   * Convert an instance of CaEventStockMerger to an JSON string
   *
   * @return JSON string
   */
