...
public class DIVNRAActivityV2 implements Serializable {
  ...
  public DIVNRAActivityV2 groupId(@javax.annotation.Nullable UUID groupId) {
  ...
  public DIVNRAActivityV2 systemDate(@javax.annotation.Nonnull LocalDate systemDate) {
  ...
  public DIVNRAActivityV2 cusip(@javax.annotation.Nonnull String cusip) {
    this.cusip = cusip;
    return this;
  }
  ...
  public DIVNRAActivityV2 symbol(@javax.annotation.Nonnull String symbol) {
    this.symbol = symbol;
    return this;
  }
   ...
   * @return the DIVNRAActivityV2 instance itself
   */
  public DIVNRAActivityV2 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    DIVNRAActivityV2 diVNRAActivityV2 = (DIVNRAActivityV2) o;
    return Objects.equals(this.groupId, diVNRAActivityV2.groupId) &&
  ...
  public String toString() {
    ...
    sb.append("class DIVNRAActivityV2 {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DIVNRAActivityV2
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DIVNRAActivityV2.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DIVNRAActivityV2 is not found in the empty JSON string", DIVNRAActivityV2.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DIVNRAActivityV2.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DIVNRAActivityV2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DIVNRAActivityV2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DIVNRAActivityV2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DIVNRAActivityV2.class));

       return (TypeAdapter<T>) new TypeAdapter<DIVNRAActivityV2>() {
           @Override
           public void write(JsonWriter out, DIVNRAActivityV2 value) throws IOException {
           ...
           @Override
           public DIVNRAActivityV2 read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             DIVNRAActivityV2 instance = thisAdapter.fromJsonTree(jsonObj);
   ...
   * @return An instance of DIVNRAActivityV2
   * @throws IOException if the JSON string is invalid with respect to DIVNRAActivityV2
   */
  public static DIVNRAActivityV2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DIVNRAActivityV2.class);
  }
