...
import markets.alpaca.client.openapi.trading.model.PortfolioHistory;
 ...
 * <ul>
 * 
 *   <li><b>{@code getAccountPortfolioHistory}</b>: Get Account Portfolio History</li>
 * 
 * </ul>
 */
public class PortfolioHistoryApi {
    ...
    private okhttp3.Call getAccountPortfolioHistoryValidateBeforeCall(@javax.annotation.Nullable String period, @javax.annotation.Nullable String timeframe, @javax.annotation.Nullable String intradayReporting, @javax.annotation.Nullable OffsetDateTime start, @javax.annotation.Nullable String pnlReset, @javax.annotation.Nullable OffsetDateTime end, @javax.annotation.Nullable String extendedHours, @javax.annotation.Nullable String cashflowTypes, final ApiCallback _callback) throws ApiException {
        return getAccountPortfolioHistoryCall(period, timeframe, intradayReporting, start, pnlReset, end, extendedHours, cashflowTypes, _callback);
     ...
     */
    public PortfolioHistory getAccountPortfolioHistory(@javax.annotation.Nullable String period, @javax.annotation.Nullable String timeframe, @javax.annotation.Nullable String intradayReporting, @javax.annotation.Nullable OffsetDateTime start, @javax.annotation.Nullable String pnlReset, @javax.annotation.Nullable OffsetDateTime end, @javax.annotation.Nullable String extendedHours, @javax.annotation.Nullable String cashflowTypes) throws ApiException {
        ApiResponse<PortfolioHistory> localVarResp = getAccountPortfolioHistoryWithHttpInfo(period, timeframe, intradayReporting, start, pnlReset, end, extendedHours, cashflowTypes);
     ...
     */
    public ApiResponse<PortfolioHistory> getAccountPortfolioHistoryWithHttpInfo(@javax.annotation.Nullable String period, @javax.annotation.Nullable String timeframe, @javax.annotation.Nullable String intradayReporting, @javax.annotation.Nullable OffsetDateTime start, @javax.annotation.Nullable String pnlReset, @javax.annotation.Nullable OffsetDateTime end, @javax.annotation.Nullable String extendedHours, @javax.annotation.Nullable String cashflowTypes) throws ApiException {
        okhttp3.Call localVarCall = getAccountPortfolioHistoryValidateBeforeCall(period, timeframe, intradayReporting, start, pnlReset, end, extendedHours, cashflowTypes, null);
