...
public class OpcaNCActivityV2 implements Serializable {
  ...
  public OpcaNCActivityV2() {
  }

  public OpcaNCActivityV2 groupId(@javax.annotation.Nullable UUID groupId) {
  ...
  public OpcaNCActivityV2 systemDate(@javax.annotation.Nonnull LocalDate systemDate) {
  ...
  public OpcaNCActivityV2 caId(@javax.annotation.Nullable UUID caId) {
    this.caId = caId;
    return this;
  }
  ...
  public OpcaNCActivityV2 positionDate(@javax.annotation.Nonnull LocalDate positionDate) {
  ...
  public OpcaNCActivityV2 reorgId(@javax.annotation.Nullable String reorgId) {
  ...
  public OpcaNCActivityV2 newContractSymbol(@javax.annotation.Nonnull String newContractSymbol) {
  ...
  public OpcaNCActivityV2 newQty(@javax.annotation.Nullable String newQty) {
    this.newQty = newQty;
    return this;
  }
  ...
  public OpcaNCActivityV2 oldContractSymbol(@javax.annotation.Nonnull String oldContractSymbol) {
  ...
  public OpcaNCActivityV2 oldQty(@javax.annotation.Nullable String oldQty) {
    this.oldQty = oldQty;
    return this;
  }
  ...
  public OpcaNCActivityV2 qty(@javax.annotation.Nullable String qty) {
    this.qty = qty;
    return this;
  }
  ...
  public OpcaNCActivityV2 newCusip(@javax.annotation.Nonnull String newCusip) {
  ...
  public OpcaNCActivityV2 newSymbol(@javax.annotation.Nonnull String newSymbol) {
  ...
  public OpcaNCActivityV2 oldCusip(@javax.annotation.Nonnull String oldCusip) {
  ...
  public OpcaNCActivityV2 oldSymbol(@javax.annotation.Nonnull String oldSymbol) {
   ...
   * @return the OpcaNCActivityV2 instance itself
   */
  public OpcaNCActivityV2 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    OpcaNCActivityV2 opcaNCActivityV2 = (OpcaNCActivityV2) o;
    return Objects.equals(this.groupId, opcaNCActivityV2.groupId) &&
        Objects.equals(this.systemDate, opcaNCActivityV2.systemDate) &&
        Objects.equals(this.caId, opcaNCActivityV2.caId) &&
        Objects.equals(this.positionDate, opcaNCActivityV2.positionDate) &&
        Objects.equals(this.reorgId, opcaNCActivityV2.reorgId) &&
        Objects.equals(this.newContractSymbol, opcaNCActivityV2.newContractSymbol) &&
        Objects.equals(this.newQty, opcaNCActivityV2.newQty) &&
        Objects.equals(this.oldContractSymbol, opcaNCActivityV2.oldContractSymbol) &&
        Objects.equals(this.oldQty, opcaNCActivityV2.oldQty) &&
        Objects.equals(this.qty, opcaNCActivityV2.qty) &&
        Objects.equals(this.newCusip, opcaNCActivityV2.newCusip) &&
        Objects.equals(this.newSymbol, opcaNCActivityV2.newSymbol) &&
        Objects.equals(this.oldCusip, opcaNCActivityV2.oldCusip) &&
        Objects.equals(this.oldSymbol, opcaNCActivityV2.oldSymbol)&&
        Objects.equals(this.additionalProperties, opcaNCActivityV2.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(groupId, systemDate, caId, positionDate, reorgId, newContractSymbol, newQty, oldContractSymbol, oldQty, qty, newCusip, newSymbol, oldCusip, oldSymbol, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class OpcaNCActivityV2 {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("group_id", "system_date", "ca_id", "position_date", "reorg_id", "new_contract_symbol", "new_qty", "old_contract_symbol", "old_qty", "qty", "new_cusip", "new_symbol", "old_cusip", "old_symbol"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("system_date", "position_date", "new_contract_symbol", "old_contract_symbol", "new_cusip", "new_symbol", "old_cusip", "old_symbol"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to OpcaNCActivityV2
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OpcaNCActivityV2.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in OpcaNCActivityV2 is not found in the empty JSON string", OpcaNCActivityV2.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OpcaNCActivityV2.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OpcaNCActivityV2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OpcaNCActivityV2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OpcaNCActivityV2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OpcaNCActivityV2.class));

       return (TypeAdapter<T>) new TypeAdapter<OpcaNCActivityV2>() {
           @Override
           public void write(JsonWriter out, OpcaNCActivityV2 value) throws IOException {
           ...
           @Override
           public OpcaNCActivityV2 read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             OpcaNCActivityV2 instance = thisAdapter.fromJsonTree(jsonObj);
   ...
   * @return An instance of OpcaNCActivityV2
   * @throws IOException if the JSON string is invalid with respect to OpcaNCActivityV2
   */
  public static OpcaNCActivityV2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OpcaNCActivityV2.class);
  }
