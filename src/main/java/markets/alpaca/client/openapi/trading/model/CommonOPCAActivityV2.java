...
public class CommonOPCAActivityV2 implements Serializable {
  ...
  public CommonOPCAActivityV2() {
  }

  public CommonOPCAActivityV2 groupId(@javax.annotation.Nullable UUID groupId) {
  ...
  public CommonOPCAActivityV2 systemDate(@javax.annotation.Nonnull LocalDate systemDate) {
  ...
  public CommonOPCAActivityV2 caId(@javax.annotation.Nullable UUID caId) {
    this.caId = caId;
    return this;
  }
  ...
  public CommonOPCAActivityV2 positionDate(@javax.annotation.Nonnull LocalDate positionDate) {
  ...
  public CommonOPCAActivityV2 reorgId(@javax.annotation.Nullable String reorgId) {
  ...
  public CommonOPCAActivityV2 newContractSymbol(@javax.annotation.Nonnull String newContractSymbol) {
  ...
  public CommonOPCAActivityV2 newQty(@javax.annotation.Nullable String newQty) {
    this.newQty = newQty;
    return this;
  }
  ...
  public CommonOPCAActivityV2 oldContractSymbol(@javax.annotation.Nonnull String oldContractSymbol) {
  ...
  public CommonOPCAActivityV2 oldQty(@javax.annotation.Nullable String oldQty) {
    this.oldQty = oldQty;
    return this;
  }
  ...
  public CommonOPCAActivityV2 qty(@javax.annotation.Nullable String qty) {
    this.qty = qty;
    return this;
  }
   ...
   * @return the CommonOPCAActivityV2 instance itself
   */
  public CommonOPCAActivityV2 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CommonOPCAActivityV2 commonOPCAActivityV2 = (CommonOPCAActivityV2) o;
    return Objects.equals(this.groupId, commonOPCAActivityV2.groupId) &&
        Objects.equals(this.systemDate, commonOPCAActivityV2.systemDate) &&
        Objects.equals(this.caId, commonOPCAActivityV2.caId) &&
        Objects.equals(this.positionDate, commonOPCAActivityV2.positionDate) &&
        Objects.equals(this.reorgId, commonOPCAActivityV2.reorgId) &&
        Objects.equals(this.newContractSymbol, commonOPCAActivityV2.newContractSymbol) &&
        Objects.equals(this.newQty, commonOPCAActivityV2.newQty) &&
        Objects.equals(this.oldContractSymbol, commonOPCAActivityV2.oldContractSymbol) &&
        Objects.equals(this.oldQty, commonOPCAActivityV2.oldQty) &&
        Objects.equals(this.qty, commonOPCAActivityV2.qty)&&
        Objects.equals(this.additionalProperties, commonOPCAActivityV2.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(groupId, systemDate, caId, positionDate, reorgId, newContractSymbol, newQty, oldContractSymbol, oldQty, qty, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CommonOPCAActivityV2 {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("group_id", "system_date", "ca_id", "position_date", "reorg_id", "new_contract_symbol", "new_qty", "old_contract_symbol", "old_qty", "qty"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("system_date", "position_date", "new_contract_symbol", "old_contract_symbol"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CommonOPCAActivityV2
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CommonOPCAActivityV2.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CommonOPCAActivityV2 is not found in the empty JSON string", CommonOPCAActivityV2.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CommonOPCAActivityV2.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CommonOPCAActivityV2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CommonOPCAActivityV2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CommonOPCAActivityV2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CommonOPCAActivityV2.class));

       return (TypeAdapter<T>) new TypeAdapter<CommonOPCAActivityV2>() {
           @Override
           public void write(JsonWriter out, CommonOPCAActivityV2 value) throws IOException {
           ...
           @Override
           public CommonOPCAActivityV2 read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             CommonOPCAActivityV2 instance = thisAdapter.fromJsonTree(jsonObj);
   ...
   * @return An instance of CommonOPCAActivityV2
   * @throws IOException if the JSON string is invalid with respect to CommonOPCAActivityV2
   */
  public static CommonOPCAActivityV2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CommonOPCAActivityV2.class);
  }
