...
public class ForwardSplitActivityV2 implements Serializable {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(groupId, systemDate, caId, positionDate, reorgId, newCusip, newRate, oldCusip, oldRate, payableDate, newQty, oldQty, dueBillRedemptionDate, exDate, recordDate, symbol, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("group_id", "system_date", "ca_id", "position_date", "reorg_id", "new_cusip", "new_rate", "old_cusip", "old_rate", "payable_date", "new_qty", "old_qty", "due_bill_redemption_date", "ex_date", "record_date", "symbol"));
