...
public class OpcaFSPLITActivityV2 implements Serializable {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(groupId, systemDate, caId, positionDate, reorgId, newContractSymbol, newQty, oldContractSymbol, oldQty, qty, newCusip, newRate, oldCusip, oldRate, payableDate, dueBillRedemptionDate, exDate, recordDate, symbol, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("group_id", "system_date", "ca_id", "position_date", "reorg_id", "new_contract_symbol", "new_qty", "old_contract_symbol", "old_qty", "qty", "new_cusip", "new_rate", "old_cusip", "old_rate", "payable_date", "due_bill_redemption_date", "ex_date", "record_date", "symbol"));
