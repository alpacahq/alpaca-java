...
public class ReverseSplitActivityV2 implements Serializable {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(groupId, systemDate, caId, positionDate, reorgId, newCusip, newRate, oldCusip, oldRate, payableDate, newQty, oldQty, exDate, newSymbol, recordDate, symbol, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("group_id", "system_date", "ca_id", "position_date", "reorg_id", "new_cusip", "new_rate", "old_cusip", "old_rate", "payable_date", "new_qty", "old_qty", "ex_date", "new_symbol", "record_date", "symbol"));
