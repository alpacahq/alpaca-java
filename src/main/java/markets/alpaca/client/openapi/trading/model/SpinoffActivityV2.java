...
public class SpinoffActivityV2 implements Serializable {
  ...
  public SpinoffActivityV2 groupId(@javax.annotation.Nullable UUID groupId) {
  ...
  public SpinoffActivityV2 systemDate(@javax.annotation.Nonnull LocalDate systemDate) {
  ...
  public SpinoffActivityV2 caId(@javax.annotation.Nullable UUID caId) {
    this.caId = caId;
    return this;
  }
  ...
  public SpinoffActivityV2 positionDate(@javax.annotation.Nonnull LocalDate positionDate) {
  ...
  public SpinoffActivityV2 reorgId(@javax.annotation.Nullable String reorgId) {
  ...
  public SpinoffActivityV2 dueBillRedemptionDate(@javax.annotation.Nullable LocalDate dueBillRedemptionDate) {
  ...
  public SpinoffActivityV2 exDate(@javax.annotation.Nullable LocalDate exDate) {
    this.exDate = exDate;
    return this;
  }
  ...
  public SpinoffActivityV2 newCusip(@javax.annotation.Nonnull String newCusip) {
  ...
  public SpinoffActivityV2 newIsin(@javax.annotation.Nullable String newIsin) {
  ...
  public SpinoffActivityV2 newPrice(@javax.annotation.Nonnull String newPrice) {
  ...
  public SpinoffActivityV2 newRate(@javax.annotation.Nonnull String newRate) {
  ...
  public SpinoffActivityV2 newSymbol(@javax.annotation.Nonnull String newSymbol) {
  ...
  public SpinoffActivityV2 payableDate(@javax.annotation.Nullable LocalDate payableDate) {
  ...
  public SpinoffActivityV2 recordDate(@javax.annotation.Nullable LocalDate recordDate) {
  ...
  public SpinoffActivityV2 sourceCusip(@javax.annotation.Nonnull String sourceCusip) {
  ...
  public SpinoffActivityV2 sourceIsin(@javax.annotation.Nullable String sourceIsin) {
  ...
  public SpinoffActivityV2 sourcePrice(@javax.annotation.Nonnull String sourcePrice) {
  ...
  public SpinoffActivityV2 sourceRate(@javax.annotation.Nonnull String sourceRate) {
  ...
  public SpinoffActivityV2 sourceSymbol(@javax.annotation.Nonnull String sourceSymbol) {
  ...
  public SpinoffActivityV2 newQty(@javax.annotation.Nonnull String newQty) {
    this.newQty = newQty;
    return this;
  }
  ...
  public SpinoffActivityV2 sourceQty(@javax.annotation.Nonnull String sourceQty) {
   ...
   * @return the SpinoffActivityV2 instance itself
   */
  public SpinoffActivityV2 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SpinoffActivityV2 spinoffActivityV2 = (SpinoffActivityV2) o;
    return Objects.equals(this.groupId, spinoffActivityV2.groupId) &&
        Objects.equals(this.systemDate, spinoffActivityV2.systemDate) &&
        Objects.equals(this.caId, spinoffActivityV2.caId) &&
        Objects.equals(this.positionDate, spinoffActivityV2.positionDate) &&
        Objects.equals(this.reorgId, spinoffActivityV2.reorgId) &&
        Objects.equals(this.dueBillRedemptionDate, spinoffActivityV2.dueBillRedemptionDate) &&
        Objects.equals(this.exDate, spinoffActivityV2.exDate) &&
        Objects.equals(this.newCusip, spinoffActivityV2.newCusip) &&
        Objects.equals(this.newIsin, spinoffActivityV2.newIsin) &&
        Objects.equals(this.newPrice, spinoffActivityV2.newPrice) &&
        Objects.equals(this.newRate, spinoffActivityV2.newRate) &&
        Objects.equals(this.newSymbol, spinoffActivityV2.newSymbol) &&
        Objects.equals(this.payableDate, spinoffActivityV2.payableDate) &&
        Objects.equals(this.recordDate, spinoffActivityV2.recordDate) &&
        Objects.equals(this.sourceCusip, spinoffActivityV2.sourceCusip) &&
        Objects.equals(this.sourceIsin, spinoffActivityV2.sourceIsin) &&
        Objects.equals(this.sourcePrice, spinoffActivityV2.sourcePrice) &&
        Objects.equals(this.sourceRate, spinoffActivityV2.sourceRate) &&
        Objects.equals(this.sourceSymbol, spinoffActivityV2.sourceSymbol) &&
        Objects.equals(this.newQty, spinoffActivityV2.newQty) &&
        Objects.equals(this.sourceQty, spinoffActivityV2.sourceQty)&&
        Objects.equals(this.additionalProperties, spinoffActivityV2.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(groupId, systemDate, caId, positionDate, reorgId, dueBillRedemptionDate, exDate, newCusip, newIsin, newPrice, newRate, newSymbol, payableDate, recordDate, sourceCusip, sourceIsin, sourcePrice, sourceRate, sourceSymbol, newQty, sourceQty, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SpinoffActivityV2 {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("group_id", "system_date", "ca_id", "position_date", "reorg_id", "due_bill_redemption_date", "ex_date", "new_cusip", "new_isin", "new_price", "new_rate", "new_symbol", "payable_date", "record_date", "source_cusip", "source_isin", "source_price", "source_rate", "source_symbol", "new_qty", "source_qty"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("system_date", "position_date", "new_cusip", "new_price", "new_rate", "new_symbol", "source_cusip", "source_price", "source_rate", "source_symbol", "new_qty", "source_qty"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to SpinoffActivityV2
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SpinoffActivityV2.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in SpinoffActivityV2 is not found in the empty JSON string", SpinoffActivityV2.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SpinoffActivityV2.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SpinoffActivityV2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SpinoffActivityV2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SpinoffActivityV2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SpinoffActivityV2.class));

       return (TypeAdapter<T>) new TypeAdapter<SpinoffActivityV2>() {
           @Override
           public void write(JsonWriter out, SpinoffActivityV2 value) throws IOException {
           ...
           @Override
           public SpinoffActivityV2 read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             SpinoffActivityV2 instance = thisAdapter.fromJsonTree(jsonObj);
   ...
   * @return An instance of SpinoffActivityV2
   * @throws IOException if the JSON string is invalid with respect to SpinoffActivityV2
   */
  public static SpinoffActivityV2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SpinoffActivityV2.class);
  }
