...
public class OpcaRSPLITActivityV2 implements Serializable {
  ...
  public OpcaRSPLITActivityV2() {
  }

  public OpcaRSPLITActivityV2 groupId(@javax.annotation.Nullable UUID groupId) {
  ...
  public OpcaRSPLITActivityV2 systemDate(@javax.annotation.Nonnull LocalDate systemDate) {
  ...
  public OpcaRSPLITActivityV2 caId(@javax.annotation.Nullable UUID caId) {
    this.caId = caId;
    return this;
  }
  ...
  public OpcaRSPLITActivityV2 positionDate(@javax.annotation.Nonnull LocalDate positionDate) {
  ...
  public OpcaRSPLITActivityV2 reorgId(@javax.annotation.Nullable String reorgId) {
  ...
  public OpcaRSPLITActivityV2 newContractSymbol(@javax.annotation.Nonnull String newContractSymbol) {
  ...
  public OpcaRSPLITActivityV2 newQty(@javax.annotation.Nullable String newQty) {
    this.newQty = newQty;
    return this;
  }
  ...
  public OpcaRSPLITActivityV2 oldContractSymbol(@javax.annotation.Nonnull String oldContractSymbol) {
  ...
  public OpcaRSPLITActivityV2 oldQty(@javax.annotation.Nullable String oldQty) {
    this.oldQty = oldQty;
    return this;
  }
  ...
  public OpcaRSPLITActivityV2 qty(@javax.annotation.Nullable String qty) {
    this.qty = qty;
    return this;
  }
  ...
  public OpcaRSPLITActivityV2 newCusip(@javax.annotation.Nonnull String newCusip) {
  ...
  public OpcaRSPLITActivityV2 newIsin(@javax.annotation.Nullable String newIsin) {
  ...
  public OpcaRSPLITActivityV2 newRate(@javax.annotation.Nonnull String newRate) {
  ...
  public OpcaRSPLITActivityV2 oldCusip(@javax.annotation.Nonnull String oldCusip) {
  ...
  public OpcaRSPLITActivityV2 oldIsin(@javax.annotation.Nullable String oldIsin) {
  ...
  public OpcaRSPLITActivityV2 oldRate(@javax.annotation.Nonnull String oldRate) {
  ...
  public OpcaRSPLITActivityV2 payableDate(@javax.annotation.Nullable LocalDate payableDate) {
  ...
  public OpcaRSPLITActivityV2 exDate(@javax.annotation.Nullable LocalDate exDate) {
    this.exDate = exDate;
    return this;
  }
  ...
  public OpcaRSPLITActivityV2 newSymbol(@javax.annotation.Nullable String newSymbol) {
  ...
  public OpcaRSPLITActivityV2 recordDate(@javax.annotation.Nullable LocalDate recordDate) {
  ...
  public OpcaRSPLITActivityV2 symbol(@javax.annotation.Nonnull String symbol) {
    this.symbol = symbol;
    return this;
  }
   ...
   * @return the OpcaRSPLITActivityV2 instance itself
   */
  public OpcaRSPLITActivityV2 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    OpcaRSPLITActivityV2 opcaRSPLITActivityV2 = (OpcaRSPLITActivityV2) o;
    return Objects.equals(this.groupId, opcaRSPLITActivityV2.groupId) &&
        Objects.equals(this.systemDate, opcaRSPLITActivityV2.systemDate) &&
        Objects.equals(this.caId, opcaRSPLITActivityV2.caId) &&
        Objects.equals(this.positionDate, opcaRSPLITActivityV2.positionDate) &&
        Objects.equals(this.reorgId, opcaRSPLITActivityV2.reorgId) &&
        Objects.equals(this.newContractSymbol, opcaRSPLITActivityV2.newContractSymbol) &&
        Objects.equals(this.newQty, opcaRSPLITActivityV2.newQty) &&
        Objects.equals(this.oldContractSymbol, opcaRSPLITActivityV2.oldContractSymbol) &&
        Objects.equals(this.oldQty, opcaRSPLITActivityV2.oldQty) &&
        Objects.equals(this.qty, opcaRSPLITActivityV2.qty) &&
        Objects.equals(this.newCusip, opcaRSPLITActivityV2.newCusip) &&
        Objects.equals(this.newIsin, opcaRSPLITActivityV2.newIsin) &&
        Objects.equals(this.newRate, opcaRSPLITActivityV2.newRate) &&
        Objects.equals(this.oldCusip, opcaRSPLITActivityV2.oldCusip) &&
        Objects.equals(this.oldIsin, opcaRSPLITActivityV2.oldIsin) &&
        Objects.equals(this.oldRate, opcaRSPLITActivityV2.oldRate) &&
        Objects.equals(this.payableDate, opcaRSPLITActivityV2.payableDate) &&
        Objects.equals(this.exDate, opcaRSPLITActivityV2.exDate) &&
        Objects.equals(this.newSymbol, opcaRSPLITActivityV2.newSymbol) &&
        Objects.equals(this.recordDate, opcaRSPLITActivityV2.recordDate) &&
        Objects.equals(this.symbol, opcaRSPLITActivityV2.symbol)&&
        Objects.equals(this.additionalProperties, opcaRSPLITActivityV2.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(groupId, systemDate, caId, positionDate, reorgId, newContractSymbol, newQty, oldContractSymbol, oldQty, qty, newCusip, newIsin, newRate, oldCusip, oldIsin, oldRate, payableDate, exDate, newSymbol, recordDate, symbol, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class OpcaRSPLITActivityV2 {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("group_id", "system_date", "ca_id", "position_date", "reorg_id", "new_contract_symbol", "new_qty", "old_contract_symbol", "old_qty", "qty", "new_cusip", "new_isin", "new_rate", "old_cusip", "old_isin", "old_rate", "payable_date", "ex_date", "new_symbol", "record_date", "symbol"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to OpcaRSPLITActivityV2
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OpcaRSPLITActivityV2.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in OpcaRSPLITActivityV2 is not found in the empty JSON string", OpcaRSPLITActivityV2.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OpcaRSPLITActivityV2.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OpcaRSPLITActivityV2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OpcaRSPLITActivityV2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OpcaRSPLITActivityV2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OpcaRSPLITActivityV2.class));

       return (TypeAdapter<T>) new TypeAdapter<OpcaRSPLITActivityV2>() {
           @Override
           public void write(JsonWriter out, OpcaRSPLITActivityV2 value) throws IOException {
           ...
           @Override
           public OpcaRSPLITActivityV2 read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             OpcaRSPLITActivityV2 instance = thisAdapter.fromJsonTree(jsonObj);
   ...
   * @return An instance of OpcaRSPLITActivityV2
   * @throws IOException if the JSON string is invalid with respect to OpcaRSPLITActivityV2
   */
  public static OpcaRSPLITActivityV2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OpcaRSPLITActivityV2.class);
  }
